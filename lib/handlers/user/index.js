...
SteamUser.prototype.addNewGame = function(game) {
  var sh = new schema.CMsgClientRequestFreeLicense(game);
  this._client.send({
    msg: EMsg.ClientRequestFreeLicense,
    proto: {}
  }, sh.toBuffer());
};
...
handlers[EMsg.ClientRequestFreeLicenseResponse] = function(data) {
  var res = schema.CMsgClientRequestFreeLicense.decode(data);

  this.emit('freeLicense', res);
};
